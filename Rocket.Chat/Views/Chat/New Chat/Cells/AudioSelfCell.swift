...
final class AudioSelfCell: BaseAudioMessageCell, SizingCell {
    static let identifier = String(describing: AudioSelfCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = AudioSelfCell.instantiateFromNib() else {
            return AudioSelfCell()
        }
