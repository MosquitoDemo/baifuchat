...
class FileMessageSelfCell: BaseMessageCell, SizingCell {
    static let identifier = String(describing: FileMessageSelfCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = FileMessageSelfCell.instantiateFromNib() else {
            return FileMessageSelfCell()
        }
