...
final class ReactionsSelfCell: UICollectionViewCell, BaseMessageCellProtocol, ChatCell, SizingCell {
    static let identifier = String(describing: ReactionsSelfCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = ReactionsSelfCell.instantiateFromNib() else {
            return ReactionsSelfCell()
        }
