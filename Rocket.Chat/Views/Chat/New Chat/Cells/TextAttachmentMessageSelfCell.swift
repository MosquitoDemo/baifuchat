//
//  TextAttachmentMessageSelfCell.swift
//  Rocket.Chat
//
...
final class TextAttachmentMessageSelfCell: BaseTextAttachmentMessageCell, SizingCell {
    static let identifier = String(describing: TextAttachmentMessageCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = TextAttachmentMessageSelfCell.instantiateFromNib() else {
            return TextAttachmentMessageSelfCell()
        }
    ...
    @IBOutlet weak var fieldsStackViewBottomConstraint: NSLayoutConstraint!
    ...
    override func awakeFromNib() {
        ...
        textContainerTrailingInitialConstant = textContainerLeadingConstraint.constant
    ...
    override func configure(completeRendering: Bool) {
        guard let viewModel = viewModel?.base as? TextAttachmentSelfChatItem else {
            return
        }
    ...
    func configureCollapsedState(with viewModel: TextAttachmentSelfChatItem) {
    ...
    func configureExpandedState(with viewModel: TextAttachmentSelfChatItem) {
...
extension TextAttachmentMessageSelfCell {
