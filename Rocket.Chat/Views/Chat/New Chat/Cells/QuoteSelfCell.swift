...
final class QuoteSelfCell: BaseQuoteMessageCell, SizingCell {
    static let identifier = String(describing: QuoteSelfCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = QuoteSelfCell.instantiateFromNib() else {
            return QuoteSelfCell()
        }
