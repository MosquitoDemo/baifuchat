...
final class TextAttachmentSelfCell: BaseTextAttachmentMessageCell, SizingCell {
    static let identifier = String(describing: TextAttachmentSelfCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = TextAttachmentSelfCell.instantiateFromNib() else {
            return TextAttachmentSelfCell()
        }
...
extension TextAttachmentSelfCell {
