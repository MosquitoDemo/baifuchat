...
final class VideoMessageSelfCell: BaseVideoMessageCell, SizingCell {
    static let identifier = String(describing: VideoMessageSelfCell.self)
    
    static let sizingCell: UICollectionViewCell & ChatCell = {
        guard let cell = VideoMessageSelfCell.instantiateFromNib() else {
            return VideoMessageSelfCell()
        }
